...
public class RightAuto {
    ...
    public static final Pose2d START_POSE_A = new Pose2d(34, -48, Math.toRadians(60));
    public static final Pose2d START_POSE_B = new Pose2d(36, -24, Math.toRadians(120));
    public static final Pose2d SCORE_POSE = new Pose2d(31, -7, Math.toRadians(-225));
    public static final Pose2d CONE_POSE = new Pose2d(57.5, -11.25, Math.toRadians(0));

    public static final Pose2d ZONE_ONE = new Pose2d(59, -12, Math.toRadians(180));
