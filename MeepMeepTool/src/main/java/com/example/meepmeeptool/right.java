...
public class right {
    ...
    public static final Pose2d START_POSE_A = new Pose2d(-36, -48, Math.toRadians(120));
    public static final Pose2d START_POSE_B = new Pose2d(-36, -24, Math.toRadians(70));
    public static final Pose2d SCORE_POSE_1 = new Pose2d(-35, -7, Math.toRadians(45));
    public static final Pose2d SCORE_POSE = new Pose2d(-7, -16, Math.toRadians(-45));
    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(START_POSE)
                                ...
                                .splineToSplineHeading(SCORE_POSE_1, SCORE_POSE_1.getHeading())
                                .waitSeconds(1)
