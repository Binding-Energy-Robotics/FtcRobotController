...
public class LeftAuto extends CommandOpMode {
	...
	public static final Pose2d SCORE_POSE_ZERO = new Pose2d(-28, -8.5, Math.toRadians(45));
	public static final Pose2d SCORE_POSE_ONE = new Pose2d(-27, -9.5, Math.toRadians(45));
	public static final Pose2d SCORE_POSE_TWO = new Pose2d(-26, -10.5, Math.toRadians(45));
	...
	public static final Pose2d CONE_POSE_TWO = new Pose2d(-58, -12.8, Math.toRadians(0));
	...
	public static final Pose2d ZONE_ONE = new Pose2d(-56, -14, Math.toRadians(0));
	public static final Pose2d ZONE_TWO = new Pose2d(-36, -14, Math.toRadians(90));
	public static final Pose2d ZONE_THREE = new Pose2d(-12, -14, Math.toRadians(90));
