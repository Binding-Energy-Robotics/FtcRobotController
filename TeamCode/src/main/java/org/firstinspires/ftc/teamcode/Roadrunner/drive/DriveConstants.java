...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(0, 0, 0, 10.04);
    ...
    public static double gyrationConstant = 0.4;
     ...
     */
    public static double MAX_VEL = 70 * .8;
    public static double MAX_ACCEL = 50 * .8;
    public static double MAX_ANG_VEL = 4.5 * .8;
