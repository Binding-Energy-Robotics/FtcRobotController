...
public class RightAuto extends CommandOpMode {
    ...
    public static Pose2d SCORE_POSE_ZERO = new Pose2d(32, -6, Math.toRadians(-225));
    public static Pose2d SCORE_POSE_ONE = new Pose2d(32, -6, Math.toRadians(-225));
    public static Pose2d SCORE_POSE_TWO = new Pose2d(31, -7, Math.toRadians(-225));
    public static Pose2d SCORE_POSE_THREE = new Pose2d(31, -7, Math.toRadians(-225));
    public static Pose2d SCORE_POSE_FOUR = new Pose2d(31, -7, Math.toRadians(-225));
    public static Pose2d SCORE_POSE_FIVE = new Pose2d(31, -7, Math.toRadians(-225));
