...
public class RightAuto extends CommandOpMode {
    ...
    public static Pose2d SCORE_POSE_ZERO = new Pose2d(26.2, -5, Math.toRadians(135));
    public static Pose2d SCORE_POSE_ONE = new Pose2d(26.5, -5.5, Math.toRadians(135));
    public static Pose2d SCORE_POSE_TWO = new Pose2d(26.5, -5.5, Math.toRadians(135));
    public static Pose2d SCORE_POSE_THREE = new Pose2d(26.5, -5.5, Math.toRadians(135));
    public static Pose2d SCORE_POSE_FOUR = new Pose2d(26, -5.75, Math.toRadians(135));
    public static Pose2d SCORE_POSE_FIVE = new Pose2d(26.5, -5.75, Math.toRadians(135));

    public static Pose2d CONE_POSE_ONE = new Pose2d(57.7, -10.25, Math.toRadians(0));
    public static Pose2d CONE_POSE_TWO = new Pose2d(57.6, -10.25, Math.toRadians(0));
    public static Pose2d CONE_POSE_THREE = new Pose2d(57.5, -9.75, Math.toRadians(0));
